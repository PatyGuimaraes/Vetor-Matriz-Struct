...
int main (){
	...
	prod vendaMensal[4][6], prodMaiorBaixa;//prodMaiorBaixa - variável para fazer a comparação dentro da matriz e apresentar o que se pede.
	int i, j;
	...
	prodMaiorBaixa = vendaMensal[0][0];//usei só a matriz que assim pega todos os atributos da struct.
